...
exports.GovernmentInfoRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newAddressEI = yield (0, GovernmentInfo_repo_1.createGovernmentInfo)({
            CURP,
...
// READ
exports.GovernmentInfoRouter.get("/:addressExtraInfoId/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// UPDATE
exports.GovernmentInfoRouter.put("/:addressExtraInfoId", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { addressExtraInfoId } = req.params;
        const { CURP, identification_number, user_id } = req.body;
        const foundAddressEI = yield (0, GovernmentInfo_repo_1.readGovernmentInfo)(+addressExtraInfoId);
